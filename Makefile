...
#    Updated: 2025/03/13 20:59:22 by mboutahi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME_SERVER):	$(SOURCE_SERVER)
	$(CC) $(CFLAGS) $(SOURCE_SERVER) -o $(NAME_SERVER)

$(NAME_CLIENT):	$(SOURCE_CLIENT)
	$(CC) $(CFLAGS) $(SOURCE_CLIENT) -o $(NAME_CLIENT)
